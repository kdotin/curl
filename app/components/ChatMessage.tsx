    ...
    return (
      <div className="flex justify-start mb-4">
        <div className="max-w-[90%] py-2">
          ...
          <div className="text-sm mb-3 leading-relaxed" style={{ color: colors.text }}>
...
function AuthRequestMessage({ content, timestamp, onAuthSubmit, onAuthSkip }: {
  ...
  // Function to format instructions with clickable links and markdown
  const formatInstructions = (text: any) => {
    ...
    // Use the same formatMarkdownText function
